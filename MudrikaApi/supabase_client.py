...
def fetch_single_user_data(accid):
    data1 = supabase.table('authority').select('accid').eq('accid',accid).execute()
...
#insert_into_db("1010","national","Devu","diya","kerala","tvm","devudiya")
#fetch_data()
# fetch_single_user_data(1009)
